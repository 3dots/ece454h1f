	 ...
	 int *x_lookup)
{
    ...
    int kman;
    //printf("\n\n\nnum_nets_affected HAS MOFOSIZE: %d\n\n\n", num_nets_affected);
    for(k = 0; k < num_nets_affected; k++) //17 million times this is executed. Should we try to unroll/tile num_nets_affected is
	{//really small 1-50. Pointless for cache. Unrolling or seek other loops?
